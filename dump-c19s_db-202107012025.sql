...
--
-- Host: 127.0.0.1    Database: c19s_db
-- ------------------------------------------------------
...
--
-- Table structure for table `sample_logs`
--

DROP TABLE IF EXISTS `sample_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sample_logs` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `sample_id` bigint(20) unsigned DEFAULT NULL,
  `user_id` bigint(20) unsigned DEFAULT NULL COMMENT 'admin yang mengesahkan',
  `status` varchar(100) DEFAULT NULL COMMENT 'status antara LABEL atau VERIFIED',
  `label` varchar(100) DEFAULT NULL COMMENT 'LABEL (EXTRACT, MIXING, PCR) VERIFY (POSITIVE, NEGATIVE)',
  `description` text DEFAULT NULL COMMENT 'descripction as json for PCR',
  `created_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sample_logs_sample_id_IDX` (`sample_id`) USING BTREE,
  KEY `sample_logs_user_id_IDX` (`user_id`) USING BTREE,
  CONSTRAINT `sample_logs_FK` FOREIGN KEY (`sample_id`) REFERENCES `samples` (`id`),
  CONSTRAINT `sample_logs_FK_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sample_logs`
--

LOCK TABLES `sample_logs` WRITE;
/*!40000 ALTER TABLE `sample_logs` DISABLE KEYS */;
INSERT INTO `sample_logs` VALUES (1,1,2,'LABEL','EXTRACTING',NULL,'2021-06-25 15:32:22'),(2,1,2,'LABEL','MIXING',NULL,'2021-06-25 16:32:22'),(3,1,2,'LABEL','PCR','{\"FAM\":\"5\",\"Cy5\":\"3\",\"ROX\":\"3\",\"JOE\":\"2\"}','2021-06-25 17:32:22'),(4,2,2,'LABEL','EXTRACTING',NULL,'2021-06-25 17:32:22'),(5,2,2,'LABEL','MIXING',NULL,'2021-06-25 17:32:22'),(6,3,2,'LABEL','EXTRACTING',NULL,'2021-06-25 17:32:22'),(7,3,2,'LABEL','MIXING',NULL,'2021-06-25 17:32:22'),(8,3,2,'LABEL','PCR','{\"FAM\":\"5\",\"Cy5\":\"3\",\"ROX\":\"3\",\"JOE\":\"2\"}','2021-06-25 17:32:22'),(9,3,3,'VERIFY','NEGATIVE',NULL,'2021-06-25 17:32:22'),(10,4,2,'LABEL','TIDAK_LAYAK',NULL,'2021-06-25 17:32:22'),(11,5,2,'LABEL','EXTRACTING',NULL,'2021-06-25 17:32:22'),(12,5,2,'LABEL','MIXING',NULL,'2021-06-25 17:32:22'),(13,5,2,'LABEL','PCR','{\"FAM\":\"5\",\"Cy5\":\"3\",\"ROX\":\"3\",\"JOE\":\"2\"}','2021-06-25 17:32:22'),(14,5,3,'VERIFY','POSITIVE',NULL,'2021-06-25 17:32:22'),(15,17,1,'LABEL','EXTRACTING',NULL,'2021-07-01 19:44:57'),(16,17,1,'LABEL','MIXING',NULL,'2021-07-01 19:45:58'),(17,17,1,'LABEL','PCR','{\"FAM\":\"2\",\"Cy5\":\"3\",\"ROX\":\"2\",\"JOE\":\"3\"}','2021-07-01 20:07:45'),(18,17,1,'VERIFY','POSITIVE',NULL,'2021-07-01 20:08:04'),(19,18,1,'LABEL','EXTRACTING',NULL,'2021-07-01 20:08:42'),(20,18,1,'LABEL','TIDAK_LAYAK',NULL,'2021-07-01 20:08:48'),(21,19,2,'LABEL','EXTRACTING',NULL,'2021-07-01 20:10:43'),(22,19,2,'LABEL','MIXING',NULL,'2021-07-01 20:10:58'),(23,19,2,'LABEL','PCR','{\"FAM\":\"2\",\"Cy5\":\"4\",\"ROX\":\"5\",\"JOE\":\"2\"}','2021-07-01 20:11:12'),(24,19,3,'VERIFY','NEGATIVE',NULL,'2021-07-01 20:11:49');
/*!40000 ALTER TABLE `sample_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `samples` VALUES (1,1,1,1,'USR001','JUST TEST lorem ipsum dolor asmet do salama keno','2021-06-07 15:33:37','2021-06-25 15:32:22','LABELED','PROCESS','PCR'),(2,2,4,3,'USR002','Test Coy','2021-06-07 18:42:55','2021-06-07 18:42:55','LABELED','PROCESS','MIXING'),(3,3,3,2,'USR003','JUST TEST','2021-06-07 16:05:47','2021-06-07 16:05:48','VERIFIED','NEGATIVE','PCR'),(4,4,3,3,'USR004','JUST TEST','2021-06-07 16:33:13','2021-06-07 16:33:15','LABELED','PROCESS','TIDAK_LAYAK'),(5,4,4,3,'USR012','test data','2021-06-07 18:42:55','2021-06-07 19:12:46','VERIFIED','POSITIVE','PCR'),(6,2,2,2,'USR005','Test lagi','2021-06-07 18:42:55','2021-06-07 19:12:46','ISSUED','PROCESS','PROCESS'),(17,4,4,3,'USR123',' Test 123','2021-07-01 20:09:52','2021-07-01 20:09:52','VERIFIED','POSITIVE','PCR'),(18,4,1,1,'USR321',' TEST SAJA','2021-07-01 20:09:59','2021-07-01 20:09:59','LABELED','PROCESS','TIDAK_LAYAK'),(19,1,1,2,'USR456',' asd qwe','2021-07-01 20:10:05','2021-07-01 20:11:49','VERIFIED','NEGATIVE','PCR');
...
--
-- Dumping routines for database 'c19s_db'
--
...
-- Dump completed on 2021-07-01 20:25:28

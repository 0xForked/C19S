	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="mb-3">
					<label for="label_status" class="col-form-label">Label</label>
					...
					<div class="col-6">
						<div class="form-group mb-4">
							...
							<div class="input-group">
								<input id="fam" type="number" name="fam" class="form-control" value="0" step="0.01">
							</div>
						</div>
						<div class="form-group mb-4">
							<label for="cy5">Gen N (Cy5)</label>
							<div class="input-group">
								<input id="cy5" type="number" name="cy5" class="form-control" value="0" step="0.01">
							</div>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group mb-4">
							...
							<div class="input-group">
								<input id="rox" type="number" name="rox" class="form-control" value="0" step="0.01">
							</div>
						</div>
						<div class="form-group mb-4">
							<label for="joe">IC Control (JOE)</label>
							<div class="input-group">
								<input id="joe" type="number" name="joe" class="form-control" value="0" step="0.01">
							</div>
						</div>
					</div>
				</div>

		...
		<section>
			<div class="d-flex justify-content-between w-100 flex-wrap py-4 px-3">
				<div class="mb-3 mb-lg-0">
					<h1 class="h4">User >> Akun >> Upgrade</h1>
					<p class="mb-0">
						Upgrade akun pengguna!
					</p>
				</div>
			</div>
		</section>
						...
						<div class="col-12 col-md-8">
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input id="name" type="text" name="name" class="form-control" value="<?= $user->name ?>" autofocus required>
									<?= form_error(
										'email',
						...
						<div class="col-12 col-md-8">
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input type="password" placeholder="* * * * * *" class="form-control" id="old_password" name="old_password" required>
									<?= form_error(
										'old_password',
										'<span class="invalid-feedback" role="alert"><strong>',
										'</strong></span>'
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input type="password" placeholder="* * * * * *" class="form-control" id="new_password" name="new_password" required>
									<?= form_error(
										'new_password',
										'<span class="invalid-feedback" role="alert"><strong>',
										'</strong></span>'

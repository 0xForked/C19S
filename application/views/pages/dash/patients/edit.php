						...
						<div class="col-12 col-md-8">
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input id="nik" type="text" name="nik" class="form-control" value="<?= $patient->nik ?>" autofocus required>
									<?= form_error(
										'nik',
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input id="place_of_birth" type="text" name="place_of_birth" class="form-control" value="<?= $patient->place_of_birth ?>" autofocus required>
									<?= form_error(
										'place_of_birth',
										'<span class="invalid-feedback" role="alert"><strong>',
										'</strong></span>'
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input id="date_of_birth" type="date" name="date_of_birth" class="form-control" value="<?= $patient->date_of_birth ?>" autofocus required>
									<?= form_error(
										'date_of_birth',
										'<span class="invalid-feedback" role="alert"><strong>',
										'</strong></span>'
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input id="name" type="text" name="name" class="form-control" value="<?= $patient->name ?>" autofocus required>
									<?= form_error(
										'name',
										'<span class="invalid-feedback" role="alert"><strong>',
										'</strong></span>'
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input id="phone" type="text" name="phone" class="form-control" value="<?= $patient->phone ?>" required>
									<?= form_error(
										'phone',
										'<span class="invalid-feedback" role="alert"><strong>',
										'</strong></span>'

		...
		<div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
			<div class="d-flex align-items-center">
				<div class="user-avatar lg-avatar me-4">
					<img
						src="<?= base_url('assets/vendor/volt/dist/img/brand/light.svg') ?>"
		...
		<ul class="nav flex-column pt-3 pt-md-0">
			<li class="nav-item">
				<a href="#" class="nav-link d-flex align-items-center disabled">
					...
					<span class="mt-1 ms-1 sidebar-text">COVID-19 SAMPLES</span>
				</a>
			</li>
			...
			<li class="nav-item">
				...
				<div
					class="multi-level collapse <?= ($this->uri->segment(1) === 'references') ? 'show' : ''?>"
					role="list"
			...
			<li class="nav-item <?= ($this->uri->segment(1) === 'samples') ? 'active' : '' ?> mt-3">
				<a href="<?= base_url('samples') ?>" class="nav-link">
					...
					<span class="sidebar-text">Sample</span>
				</a>
			</li>
			...
			<li class="nav-item">
				...
				<div
					class="multi-level collapse <?= ($this->uri->segment(1) === 'users') ? 'show' : ''?>"
					role="list"
					id="submenu-users"
					aria-expanded="false"
				>
